...
//                "http://look.appjx.cn/mobile_api.php?mod=news&id=12604"
    ...
    private void getNoticeInfo() {
        UserRequest.getNoticeInfo(mContext, uuid, new RequestResultI() {
            @Override
...
//            CGLog.d("isFavour" + article.isFavor());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.textview_2://分享
                ...
                ShareUtils.showShareDialog(NoticeActivity.this, tvSHare, article.getData().getTitle(),
    ...
    private void zan() {
        dialog = new HintInfoDialog(NoticeActivity.this, "点赞中，请稍后...");
        dialog.show();
        UserRequest.zan(NoticeActivity.this, article.getData().getUuid(), NormalReplyListActivity.REPLY_TYPE_SCHOOL_NOTICE, new RequestResultI() {
            @Override
            public void result(BaseModel domain) {
                dialog.dismiss();
                Utils.showToast(NoticeActivity.this, "点赞成功");
                zan1();
            }
    ...
    private void cacelZan() {
        dialog = new HintInfoDialog(NoticeActivity.this, "取消点赞中，请稍后...");
        dialog.show();
        UserRequest.zanCancel(NoticeActivity.this, article.getData().getUuid(), new RequestResultI() {
            @Override
            public void result(BaseModel domain) {
                dialog.dismiss();
                Utils.showToast(NoticeActivity.this, "取消点赞成功");
                zan2();
            }
    ...
    private void store() {
        dialog = new HintInfoDialog(NoticeActivity.this, "收藏中，请稍后...");
        dialog.show();
        UserRequest.store(NoticeActivity.this, article.getData().getTitle(),NormalReplyListActivity.REPLY_TYPE_SCHOOL_NOTICE , article.getData().getUuid(), "", new RequestResultI() {
            @Override
            public void result(BaseModel domain) {
                dialog.dismiss();
                Utils.showToast(NoticeActivity.this, "收藏成功");
                store1();
            }
    ...
    private void cancelStore() {
        dialog = new HintInfoDialog(NoticeActivity.this, "取消收藏中，请稍后...");
        dialog.show();
        UserRequest.cancelStore(formStore, NoticeActivity.this, article.getData().getUuid(), new RequestResultI() {
            @Override
            public void result(BaseModel domain) {
                dialog.dismiss();
                Utils.showToast(NoticeActivity.this, "取消收藏成功");
                store2();
            }
