...
//                     showView();
    ...
    private void addListDataByDate(List<QueryGroupCount> allList) {
        ...
        for (QueryGroupCount count : allList) {
            ...
            //TODO 备注,此时查询数量加上排序限制.
            String orderBy = "photo_time limit 6";
            List<AllPfAlbumSunObject> objectList = mPfLoadDataProxy.queryListByDateOrderBy(family_uuid, count.getDate(),orderBy);
